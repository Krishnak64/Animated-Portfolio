  ...
  return (
    <nav>
        ...
        <ul className='mobilemenu' ref={mobile}>
            <Link to="home" activeClass="active" spy={true} smooth={true} duration={500}>Home</Link>
            <Link to="about" activeClass='active' spy={true} smooth={true} duration={500}>About</Link>
            <Link to="projects" activeClass='active' spy={true} smooth={true} duration={500}>Projects</Link>
            <Link to="contact" activeClass='active' spy={true} smooth={true} duration={500}>Contact</Link>
        </ul>
    </nav>
  )
}
